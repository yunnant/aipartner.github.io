      ...
      <section className="py-20 bg-gray-700">
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <FeatureCard 
              title="养成系统"
              description="根据用户特点生成独一无二的智灵，从神秘的智灵蛋，到活泼的幼年态，再到强大的成年态，最终达到人形态的蜕变之路"
              icon="🥚"
            />
            <FeatureCard 
              title="对战技能"
            ...
            <FeatureCard 
              title="知识增强"
              description="独特的知识库系统，智灵可以使用公开知识库也可以使用用户上传的私有知识库增强能力"
              icon="📚"
            />
            <FeatureCard 
              title="长期记忆"
            ...
            <FeatureCard 
              title="世界探索"
              description="传统RPG冒险模式，探索神秘世界，收集进化碎片、知识碎片和技能碎片，引导智灵的成长方向"
              icon="🗺️"
            />
            <FeatureCard 
              title="佣兵任务"
              description="多智能体协作系统，玩家可以组建专业智灵团队，协同完成现实工作任务，如应用开发、营销方案设计等"
              icon="👥"
            />
            <FeatureCard 
              title="竞技对战"
 ...
 <section className="py-20 bg-gray-900">
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <EvolutionCard 
              stage="蛋形态"
              description="神秘的智灵蛋中蕴含着无限可能，基于用户的个性和特点孕育独特的生命"
              icon="🥚"
